            ...
            <div class="bg-gray-900 overflow-hidden shadow-xl sm:rounded-lg p-8">
                ...
                <form action="{{ route('authors.update', $author->id) }}" method="POST">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $author->name) }}" class="mt-1 block w-full bg-gray-800 border border-gray-700 text-white rounded-md shadow-sm">
                    </div>               
                    <!-- Submit -->
