    ...
    <div class="py-12 bg-black min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-900 overflow-hidden shadow-xl sm:rounded-lg p-8">
                ...
                <form action="{{ route('generes.update', $genere->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $genere->name) }}" class="mt-1 block w-full bg-gray-800 border border-gray-700 text-white rounded-md shadow-sm">
                    </div>               
                    <!-- Submit -->
